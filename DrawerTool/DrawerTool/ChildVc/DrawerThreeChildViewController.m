//
//  DrawerThreeChildViewController.m
//  YYBS_DrawerTool
//
...
@interface DrawerThreeChildViewController ()

@end

@implementation DrawerThreeChildViewController
...
- (void)viewDidLoad {
    ...
    ybs_titleLable.text = @" 第三个 \n我是抽屉列表中 第三个控制器";
    ybs_titleLable.numberOfLines = 0;
    ybs_titleLable.textAlignment = NSTextAlignmentCenter;
    ybs_titleLable.frame = CGRectMake(0, 0, self.view.bounds.size.width, 200);    ybs_titleLable.center = self.view.center;

...
@interface NavVcHomeViewController ()

@end

@implementation NavVcHomeViewController
...
- (void)viewDidLoad {
    ...
    ybs_titleLable.text = @"这个是在 UINavigationController 的设计模式下 navVc的根控制器";
